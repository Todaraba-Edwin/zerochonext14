...
import * as Segment from 'next/navigation'
import React from 'react'
import style from './navMenu.module.css'

export default function NavMenu() {
  const segment: string|null = Segment.useSelectedLayoutSegment()
  const segments: string[]|null = Segment.useSelectedLayoutSegments()
  console.log('segment', segment, 'segments', segments);   // segment, "compose", segments : ['compose', 'tweet']
  
  
  const me : {id:string} = {id:'edwin'} // 임시객체
